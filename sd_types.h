 ...
 */
#ifndef SD_TYPES_H_INCLUDED
#define SD_TYPES_H_INCLUDED
...
typedef struct {
	...
	uint8_t		product_name[7];			/*!< product name, ASCII, NULL terminated */
	uint8_t		product_rev;				/*!< product revision, BCD */
	uint32_t	product_sn;					/*!< product serial number */
	uint16_t	mfg_year;					/*!< year of manufacture */
	uint8_t	    mfg_month;					/*!< month of manufacture (e.g. 0x4 = April) */
	uint8_t		crc;						/*!< CRC7 */
} sd_card_cid_t;
